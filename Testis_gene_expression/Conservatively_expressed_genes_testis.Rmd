...
```{r}
load("/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/Cattle/counts_Cattle_UOA_Wagyu_1_Y.rda")
load("/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/Cattle/annotation_Cattle.UOA_Wagyu_1_Y.rda")
...
write_rds(count_anno_list,"/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/Expressed_genes/Cattle_count_anno_list_TMM.rds")
```
...
load("/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/Human/counts_Human_T2T-CHM13v2.0.rda")
load("/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/Human/annotation_Human.T2T-CHM13v2.0.rda")
...
write_rds(count_anno_list,"/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/Expressed_genes/Human_count_anno_list_TMM.rds")
```
...
load("/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/Chimpanzee/counts_Chimpanzee_T2Tv2.0.rda")
load("/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/Chimpanzee/annotation_Chimpanzee.T2Tv2.0.rda")
...
write_rds(count_anno_list,"/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/Expressed_genes/Chimpanzee_count_anno_list_TMM.rds")
```
## Gorilla

```{r}

load("/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/Gorilla/PRJEB48233/counts_PRJEB48233_Gorilla.T2Tv2.0.rda")

countsensembl_1 <- countsensembl

load("/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/Gorilla/PRJNA304995/counts_PRJNA304995_Gorilla.T2Tv2.0.rda")
...
load("/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/Gorilla/annotation_Gorilla.T2Tv2.0.rda")
...
write_rds(count_anno_list,"/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/Expressed_genes/Gorilla_count_anno_list_TMM.rds")
```
...
load("/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/Bornean_orangutan/counts_B_orangutan_T2Tv2.0.gtf.rda")
load("/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/Bornean_orangutan/annotation_Bornean_orangutan.T2Tv2.0.rda")
...
write_rds(count_anno_list,"/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/Expressed_genes/Bornean_orangutan_count_anno_list_TMM.rds")
```
...
### Cattle
```{r}
Cattle_count_anno_list_TMM <- readRDS("/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/Expressed_genes/Cattle_count_anno_list_TMM.rds")
...
```{r}
Cattle_PAR_X <- read_xlsx("/Users/tongchen/Documents/Kelly_2024/T2T_paper/2T2_manuscript/Kel_t2t_12112024/Kel_sup_tables/Table_KEL-S2_X_gene_annotation_PAR.xlsx", sheet = 1)
...
```{r}
Human_count_anno_list_TMM <- readRDS("/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/Expressed_genes/Human_count_anno_list_TMM.rds")

Human_count_anno_list_TMM$anno$chr %>% table()
```

```{r}
Human_PAR_X <- read_xlsx("/Users/tongchen/Documents/Kelly_2024/T2T_paper/2T2_manuscript/Kel_t2t_12112024/Kel_sup_tables/Table_KEL-S2_X_gene_annotation_PAR.xlsx", sheet = 2)
...
```{r}
Chimpanzee_count_anno_list_TMM <- readRDS("/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/Expressed_genes/Chimpanzee_count_anno_list_TMM.rds")
...
```{r}
Chimpanzee_PAR_X <- read_xlsx("/Users/tongchen/Documents/Kelly_2024/T2T_paper/2T2_manuscript/Kel_t2t_12112024/Kel_sup_tables/Table_KEL-S2_X_gene_annotation_PAR.xlsx", sheet = 3)
...
```{r}
Gorilla_count_anno_list_TMM <- readRDS("/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/Expressed_genes/Gorilla_count_anno_list_TMM.rds")
...
```{r}
Gorilla_PAR_X <- read_xlsx("/Users/tongchen/Documents/Kelly_2024/T2T_paper/2T2_manuscript/Kel_t2t_12112024/Kel_sup_tables/Table_KEL-S2_X_gene_annotation_PAR.xlsx", sheet = 4)
...
```{r}
Bornean_orangutan_count_anno_list_TMM <- readRDS("/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/Expressed_genes/Bornean_orangutan_count_anno_list_TMM.rds")
...
```{r}
Bornean_orangutan_PAR_X <- read_xlsx("/Users/tongchen/Documents/Kelly_2024/T2T_paper/2T2_manuscript/Kel_t2t_12112024/Kel_sup_tables/Table_KEL-S2_X_gene_annotation_PAR.xlsx", sheet = 5)
...
Gene_order <- read_xlsx("/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/annotation_gene_order/Final_annotation_for_plot/Fig2_PAR_X/Gene_order_Fig2_PAR_X_final.xlsx", col_names = F) %>%
...
#   write_csv("/Users/tongchen/Documents/Kelly_2024/T2T_paper/2T2_manuscript/Kel_t2t_12112024/Kel_sup_tables/PAR_X_expressed_counts.csv")

PAR_X_expressed_counts_edited <- read_csv("/Users/tongchen/Documents/Kelly_2024/T2T_paper/2T2_manuscript/Kel_t2t_12112024/backup/tb_backup/Cattle_PAR_X_expressed_counts.csv") %>%
  reshape2::melt()
...
```{r}
Cattle_outPAR_X <- read_xlsx("/Users/tongchen/Documents/Kelly_2024/T2T_paper/2T2_manuscript/Kel_t2t_12112024/Kel_sup_tables/Table_KEL-S4_Cattle_XY_gene_annotation_outPAR.xlsx", sheet = 1)
...
Cattle_PAR_Y <- read_xlsx("/Users/tongchen/Documents/Kelly_2024/T2T_paper/2T2_manuscript/Kel_t2t_12112024/Kel_sup_tables/Table_KEL-S3_Y_gene_annotation_PAR.xlsx", sheet = 1)
...
Human_PAR_Y <- read_xlsx("/Users/tongchen/Documents/Kelly_2024/T2T_paper/2T2_manuscript/Kel_t2t_12112024/Kel_sup_tables/Table_KEL-S3_Y_gene_annotation_PAR.xlsx", sheet = 2)
...
Chimpanzee_PAR_Y <-read_xlsx("/Users/tongchen/Documents/Kelly_2024/T2T_paper/2T2_manuscript/Kel_t2t_12112024/Kel_sup_tables/Table_KEL-S3_Y_gene_annotation_PAR.xlsx", sheet = 3)
...
Gorilla_PAR_Y <-read_xlsx("/Users/tongchen/Documents/Kelly_2024/T2T_paper/2T2_manuscript/Kel_t2t_12112024/Kel_sup_tables/Table_KEL-S3_Y_gene_annotation_PAR.xlsx", sheet = 4)
...
Bornean_orangutan_PAR_Y <-read_xlsx("/Users/tongchen/Documents/Kelly_2024/T2T_paper/2T2_manuscript/Kel_t2t_12112024/Kel_sup_tables/Table_KEL-S3_Y_gene_annotation_PAR.xlsx", sheet = 5)
...
Gene_order <- read_xlsx("/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/annotation_gene_order/Final_annotation_for_plot/Fig2_PAR_X/Gene_order_Fig2_PAR_Y_final.xlsx", col_names = F) %>%
  set_colnames("gene_id")
...
#   write_csv("/Users/tongchen/Documents/Kelly_2024/T2T_paper/2T2_manuscript/Kel_t2t_12112024/Kel_sup_tables/PAR_Y_expressed_counts.csv")

PAR_Y_expressed_counts_edited <- read_csv("/Users/tongchen/Documents/Kelly_2024/T2T_paper/2T2_manuscript/Kel_t2t_12112024/Kel_sup_tables/PAR_Y_expressed_counts_edited.csv") %>%
  reshape2::melt()
...
Cattle_outPAR_Y <- read_xlsx("/Users/tongchen/Documents/Kelly_2024/T2T_paper/2T2_manuscript/Kel_t2t_12112024/Kel_sup_tables/Table_KEL-S4_Cattle_XY_gene_annotation_outPAR.xlsx", sheet = 2)
...
Cattle_gene_annotation_PEP_activeGenes_GRange_X[queryHits(activeGenes_centromere_X),] %>%
  as.data.frame() %>%
   write_tsv("/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/FPKM_expression/Cattle_count_anno_final_expression_centromere_X.tsv")
...
### Human
```{r}
Human_count_anno_final_expression <- read_xlsx("/Users/tongchen/Documents/Kelly_2024/T2T_paper/2T2_manuscript/Kel_t2t_12112024/Kel_sup_tables/Table_KEL-S6_All_expressed_counts_feature_count.xlsx", sheet = 2, col_types = c("text")) #Human
...
Human_gene_annotation_PEP_activeGenes_GRange_X[queryHits(activeGenes_centromere_X),] %>%
  as.data.frame() %>%
   write_tsv("/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/FPKM_expression/Human_count_anno_final_expression_centromere_X.tsv")
...
### Chimpanzee
```{r}
Chimpanzee_count_anno_final_expression <- read_xlsx("/Users/tongchen/Documents/Kelly_2024/T2T_paper/2T2_manuscript/Kel_t2t_12112024/Kel_sup_tables/Table_KEL-S6_All_expressed_counts_feature_count.xlsx", sheet = 3, col_types = c("text")) #Chimpanzee
...
Chimpanzee_gene_annotation_PEP_activeGenes_GRange_X[queryHits(activeGenes_centromere_X),] %>%
  as.data.frame() %>%
   write_tsv("/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/FPKM_expression/Chimpanzee_count_anno_final_expression_centromere_X.tsv")
...
### Gorilla
```{r}
Gorilla_count_anno_final_expression <- read_xlsx("/Users/tongchen/Documents/Kelly_2024/T2T_paper/2T2_manuscript/Kel_t2t_12112024/Kel_sup_tables/Table_KEL-S6_All_expressed_counts_feature_count.xlsx", sheet = 4, col_types = c("text")) #Gorilla
...
Gorilla_gene_annotation_PEP_activeGenes_GRange_X[queryHits(activeGenes_centromere_X),] %>%
  as.data.frame() %>%
   write_tsv("/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/FPKM_expression/Gorilla_count_anno_final_expression_centromere_X.tsv")
...
### Bornean_orangutan
```{r}
Bornean_orangutan_count_anno_final_expression <- read_xlsx("/Users/tongchen/Documents/Kelly_2024/T2T_paper/2T2_manuscript/Kel_t2t_12112024/Kel_sup_tables/Table_KEL-S6_All_expressed_counts_feature_count.xlsx", sheet = 5, col_types = c("text")) #Bornean_orangutan
...
Bornean_orangutan_gene_annotation_PEP_activeGenes_GRange_X[queryHits(activeGenes_centromere_X),] %>%
  as.data.frame() %>%
   write_tsv("/Users/tongchen/Documents/Kelly_2024/T2T_paper/Gene_expression_X_Y/FPKM_expression/Bornean_orangutan_count_anno_final_expression_centromere_X.tsv")
